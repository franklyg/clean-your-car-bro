  ...
  return(
    <div>
      <>
        <Layout>
          <Container>
            <h1 className="main-headline text-6xl font-bold mb-8 pt-10 mb-8">chain rings.</h1>
            ...
            {
              morePosts.length > 0 && <ProductPage posts={morePosts} uidName="chain-rings" apiName="Crankets" />
            }
          </Container>
        </Layout>
      </>
