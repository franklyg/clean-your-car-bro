        ...
        <Container>
          <div className="footer-pages">
            <div id="about">
              ...
              <h2>Welcome to Clean Your Car, Bro. </h2>
            ...
            <div id="faq-section">
              ...
              <h2>Does Clean Your Car, Bro sell product from a warehouse?</h2>
              ...
              <p>Clean Your Car, Bro does not ship out any products. Please go to your Amazon account to find this information in, Your Orders.</p>
            </div>
          </div>
        </Container>
      </Layout>
